angular.module('tus_exitos.directives', [])
...
.directive('slideCard', function() {
	return {
		templateUrl: 'views/app/wordpress/slide-card.html'
	};
})
.directive('chartCard', function() {
	return {
		templateUrl: 'views/app/wordpress/chart-card.html'
	};
})
