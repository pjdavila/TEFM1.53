angular.module('tus_exitos.factories', [])
...
.factory('WpPushServer', function ($http, WORDPRESS_PUSH_URL){
  ...
  return {
    ...
    // device_token:  device registrationId
...
.factory('AdMob', function ($window){
  ...
  if(admob)
  {
    ...
    {
      admobid = { // for iOS
        banner: 'ca-app-pub-3654903810635587/1388358664',
        interstitial: 'ca-app-pub-1139090475634740/8820757056'
      };
    }
