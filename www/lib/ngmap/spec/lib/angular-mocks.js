 ...
 *
 * <pre>
 *   TusExitosFMDev = angular.module('TusExitosFMDev', ['TusExitosFM', 'ngMockE2E']);
 *   TusExitosFMDev.run(function($httpBackend) {
...
if(window.jasmine || window.mocha) {
   ...
   * <pre>
   *
   *   angular.module('TusExitosFMlicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('TusExitosFM', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('TusExitosFMlicationModule'));
   *
   *
