 ...
 * 
 * <pre>
 * var TusExitosFM = angular.module('TusExitosFM', []);
 * TusExitosFM.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://TusExitosFM.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://TusExitosFM.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('TusExitosFM', []).config(function($sceDelegateProvider) {
 ...
 *        'http://TusExitosFM.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="TusExitosFMController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("TusExitosFMController", function TusExitosFMController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('TusExitosFMWithSceDisabledTusExitosFM', []).config(function($sceProvider) {
