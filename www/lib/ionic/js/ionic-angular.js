 ...
 * @usage
 * ```js
 * var TusExitosFM = angular.module('reallyCoolApp', ['ionic']);
 *
 * TusExitosFM.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('TusExitosFM', ['ionic'])
 ...
 *
 * ```js
 *   angular.module('TusExitosFM', ['ionic'])
 ...
 *
 * ```
 * angular.module('TusExitosFM', ['ngRoute'])`
 * ```
 *
 * becomes
 *
 * ```
 * angular.module('TusExitosFM', ['ngRoute', 'ngIOS9UIWebViewPatch'])
 * ```
 *
 *
 * More info:
