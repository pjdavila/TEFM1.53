...
var TusExitosFM = angular.module('TusExitosFM', ['youtube-embed']);
```

```javascript
// Inside your controller...
TusExitosFM.controller('MyCtrl', function ($scope) {
  // have a video id
...
```javascript
TusExitosFM.controller('MyCtrl', function ($scope, youtubeEmbedUtils) {
  // 'VvTvtIeXJ1I'
