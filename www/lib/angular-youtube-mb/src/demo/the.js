...
var TusExitosFM = angular.module('TusExitosFM', ['youtube-embed', 'ngRoute', 'hljs']);

TusExitosFM.config(['$routeProvider', function($routeProvider) {
  $routeProvider
   .when('/', {
...
TusExitosFM.controller('TheCtrl', function ($scope) {
    // have a video ID
...
TusExitosFM.controller('AdvancedCtrl', function ($scope) {
