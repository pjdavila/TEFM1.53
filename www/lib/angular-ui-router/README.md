...
```html
<!doctype html>
<html ng-app="TusExitosFM">
<head>
    <script src="//ajax.googleapis.com/ajax/libs/angularjs/1.1.5/angular.min.js"></script>
    <script src="js/angular-ui-router.min.js"></script>
    <script>
        var TusExitosFM = angular.module('TusExitosFM', ['ui.router']);
        // For Component users, it should look like this:
        // var TusExitosFM = angular.module('TusExitosFM', [require('angular-ui-router')]);
    </script>
    ...
</head>
<body>
...
>
```javascript
TusExitosFM.config(function($stateProvider, $urlRouterProvider) {
  //
...
>
```javascript
TusExitosFM.config(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
